                ...
                <div class="collapse-body">
                  <div class="widget-menu-wrap">
                    <ul class="nav-menu">
                      ...
                      <li><a href="account-login.php">Delivery Information</a></li>
                      <li><a href="account-login.php">Privacy Policy</a></li>
                      <li><a href="account-login.php">Terms & Conditions</a></li>
                      <li><a href="contact.php">Contact Us</a></li>
                      <li><a href="account-login.php">Loag In Info</a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="widget-item nav-menu-item2">
              ...
              <div id="widgetId-2" class="collapse widget-collapse-body">
                <div class="collapse-body">
                  <div class="widget-menu-wrap">
                    <ul class="nav-menu">
                      <li><a href="account-login.php">Gallery</a></li>
                      <li><a href="shop.html">Brands</a></li>
                      <li><a href="account-login.php">Gift Certificates</a></li>
                      <li><a href="shop.html">Specials</a></li>
                      <li><a href="account.php">My Account Us</a></li>
                      <li><a href="about-us.html">About Us</a></li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="footer-bottom-content">
              ...
              <div class="payment">
                <a href="account.php"><img src="assets/img/photos/payment.webp" width="192" height="21" alt="Payment Logo"></a>
              </div>
            </div>
          </div>
        </div>
